...
class ReActAgent(Agent):
    ...
    def run(self, input_text: str, **kwargs) ->str:
        ...
        while current_step < self.max_steps:
            ...
            # 解析输出
            thought, action = self._parset_output(response_text);
    ...
    # 进行LLM输出， 提取思考和行动
    def _parset_output(self, text:str) -> Tuple[Optional[str], Optional[str]]:
        thought_match = re.search(f"Thought:(.*)", text);
