...
class LlmClient:
    ...
    def _auto_detect_provider(self, api_key: Optional[str], base_url: Optional[str]) -> str:
        ...
        if actual_api_key:
            ...
            if actual_api_key.startswith("ms-"):
                ...
                return "ollama"
            elif actual_key_lower == "llama.cpp":
                return "llama.cpp"
    ...
    def _resolve_credentials(self, api_key: Optional[str], base_url: Optional[str]) -> tuple[str, str]:
        ...
        if self.provider == "openai":
            ...
            resolved_api_key = api_key or os.getenv("LLM_API_KEY") or "local"
            resolved_base_url = base_url or os.getenv("LLM_BASE_URL") or "http://127.0.0.1:8899/v1"
            return resolved_api_key, resolved_base_url
        else:
    ...
    def _get_default_model(self) -> str:
        ...
        if self.provider == "openai":
            ...
            return "ggml-org_gemma-3-12b-it-GGUF_gemma-3-12b-it-Q4_K_M"
        else:
